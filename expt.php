<html lang="en"><head>
<meta charset="UTF-8">
<title>Accept all  request in one click by access token</title>
<meta name="description" content="SCRIPT MODIFIED BY CH AHSAN">
...
<div class="jumbotron" style="margin: 1% auto;margin-top:-20px;"><center><a href="/"><img src="http://royaliker.net/img/logo.png"></a></center>

<center>
<h3 class="post-title entry-title" itemprop="name">
Accept All Friend Requests In A Click
</h3>
...
<strong><p class="sub-text margin40"><a href="http://www.royaliker.net/token1.php" target ="_blank" class="btn btn-theme-dark btn-lg">Click Here </a> To Allow Htc  App <br/>
<p class="sub-text margin40"><a href="http://www.royaliker.net/token2.php" target ="_blank" class="btn btn-theme-dark btn-lg">Click Here </a> To Get Token  <br/>
<center style="margin:10px;opacity:0.5;clear:both"><div class="kreditx"><a class="mkr" href="http://m.facebook.com/adilmalik.160">CHAUDHRY BOT TEAM 
</div></center>
</div>
</div></div>
